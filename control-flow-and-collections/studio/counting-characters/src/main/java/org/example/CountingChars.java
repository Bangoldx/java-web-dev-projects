...
public class CountingChars {
    public static void main(String[] args) {
        ...
        String blockOfText = "If the product of two terms is zero then common sense says at least one of the two terms has to be zero to start with. " +
        ...
        char[] charactersInString = blockOfText.toCharArray();
